...
export const SessionCheckModalImpl = React.forwardRef<HTMLDivElement, SessionCheckModalProps>(
    ...
    return (
      ...
      >
        ...
        <DialogContent>
          ...
          >
            <Typography id="check-session-dialog-description" variant="body1" sx={{ flex: 1 }}>
